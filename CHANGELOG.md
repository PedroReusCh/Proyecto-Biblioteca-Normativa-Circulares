...
* **Arquitectura Desacoplada de Tablas e Imágenes con Manifiestos Ligeros e IDs Canónicos**:
  ...
  * **Descontaminación del Numeral 2 en `CuerpoExtractor`**: Se implementó el filtro `_es_nota_modificacion_posterior` y limpieza en `_limpiar_texto_cuerpo`, eliminando la intrusión de recuadros marginales dentro de la cita de normas y dejando el Numeral 2 100% fiel al texto original.
