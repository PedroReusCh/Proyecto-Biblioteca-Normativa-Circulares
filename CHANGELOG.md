...
* **Arquitectura Desacoplada de Tablas e Imágenes con Manifiestos Ligeros e IDs Canónicos**:
  ...
  * **Descontaminación Integral de `CuerpoExtractor`**: Se implementó detección y omisión activa de bloques tabulares (`_es_inicio_bloque_tabla`), eliminando la filtración de tablas de modificaciones como falsos párrafos del cuerpo normativo y aislando las referencias de esquemas en el Numeral 4. DDU 456 queda estructurada exactamente en 7 párrafos normativos puros.
